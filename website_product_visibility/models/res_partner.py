...
class ResPartner(models.Model):
    ...
    select_pro_cat= fields.Selection([('products', "Products"), ('category', "Product Category")], string="Product or Category")
    product_ids = fields.Many2many("product.template", string="Products")
    product_category_ids = fields.Many2many("product.public.category", string="Categories", domain="[['parent_id', '=', False]]")
